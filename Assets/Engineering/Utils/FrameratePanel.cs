...
namespace FrameratePanel
{
    namespace KinematicCharacterController.Examples
    {
        public class FrameratePanel : MonoBehaviour
        {
            ...
            public TextMeshProUGUI PhysicsRate;
            public TextMeshProUGUI PhysicsFPS;
            public TextMeshProUGUI AvgFPS;
            public TextMeshProUGUI AvgFPSMin;
            public TextMeshProUGUI AvgFPSMax;
